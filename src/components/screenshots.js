    ...
    return (
      <section id='screenshots'>
                ...
                return (
                  <div className='columns item' key={index.toString()}>
                    <div className='item-wrap'>
                      ...
                      >
                        <img src={'images/screenshots/' + screenshot.thumb} alt={screenshot.caption} />
        ...
        <div>
          {isOpen && (
            <Lightbox
              mainSrc={'images/screenshots/big/' + screenshots[photoIndex].big}
              nextSrc={'images/screenshots/big/' + screenshots[(photoIndex + 1) % screenshots.length].big}
              prevSrc={
